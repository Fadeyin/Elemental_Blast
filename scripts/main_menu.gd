...
func _build_shop_tab():
	...
	if not LevelManager.is_starter_pack_purchased():
		var starter = _create_shop_offer(
			...
			["1000 золотых", "4× Водный шар / Огненная стрела / Вихрь / Корни"],
			"1$",
	...
	var medium = _create_shop_offer(
		...
		["2500 золотых", "5× Водный шар / Огненная стрела / Вихрь / Корни"],
		"5$",
	...
	var best = _create_shop_offer(
		"САМЫЙ ВЫГОДНЫЙ",
		"Лучшее предложение!",
		["5000 золотых", "10× Водный шар / Огненная стрела / Вихрь / Корни"],
		"9$",

...
var shuffle_booster_tutorial_shown: bool = false
var freeze_booster_tutorial_shown: bool = false
...
func is_shuffle_booster_tutorial_shown() -> bool:
	return shuffle_booster_tutorial_shown

func mark_shuffle_booster_tutorial_shown() -> void:
	if shuffle_booster_tutorial_shown:
		return
	shuffle_booster_tutorial_shown = true
	_log_analytics_event("shuffle_booster_tutorial_shown", {})
	_save_progress()

func is_freeze_booster_tutorial_shown() -> bool:
	return freeze_booster_tutorial_shown

func mark_freeze_booster_tutorial_shown() -> void:
	if freeze_booster_tutorial_shown:
		return
	freeze_booster_tutorial_shown = true
	_log_analytics_event("freeze_booster_tutorial_shown", {})
	_save_progress()
...
func _save_progress():
	...
	cfg.set_value("boosters", "shuffle_tutorial_shown", shuffle_booster_tutorial_shown)
	cfg.set_value("boosters", "freeze_tutorial_shown", freeze_booster_tutorial_shown)
...
func _load_progress():
	...
	if err == OK:
		...
		shuffle_booster_tutorial_shown = bool(cfg.get_value("boosters", "shuffle_tutorial_shown", false))
		freeze_booster_tutorial_shown = bool(cfg.get_value("boosters", "freeze_tutorial_shown", false))

# ⚡ Netlify - Быстрая настройка (5 минут)

## 🎯 Зачем?

GitHub Pages **НЕ работает** с Godot 4.6 (нет поддержки HTTP-заголовков).
Netlify **работает отлично** и настраивается за 5 минут.
